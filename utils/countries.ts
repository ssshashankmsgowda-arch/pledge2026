...
// Re-organize: India first, then everyone else sorted alphabetically
const india = allCountries.find(c => c.code === "IN");
const others = allCountries.filter(c => c.code !== "IN").sort((a, b) => a.name.localeCompare(b.name));

export const countries: Country[] = india ? [india, ...others] : allCountries;
