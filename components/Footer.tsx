      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <ul className="text-stone-400 text-sm space-y-3">
            <li><a href="#" className="hover:text-red-600 transition-colors">Partner Program</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">Case Studies</a></li>
            <li><a href="#" className="hover:text-red-600 transition-colors">Annual Report</a></li>
          </ul>
        </div>
