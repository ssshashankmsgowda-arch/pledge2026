...
const PledgeSelection: React.FC<PledgeSelectionProps> = ({ 
  ...
  const BackgroundAtmosphere = ({ image, label }: { image?: string, label?: string }) => (
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
      ...
      <div className="absolute -top-20 -left-20 w-[60rem] h-[60rem] bg-red-100/20 rounded-full blur-[150px] animate-pulse"></div>
        ...
        <div className="max-w-6xl mx-auto space-y-32 relative z-10">
          <div className="space-y-8">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-red-600 font-black text-[11px] uppercase tracking-[0.6em] outfit">Pathway 01: Core Intent</span>
            </div>
            <h2 className="text-7xl sm:text-[11rem] font-black text-stone-900 outfit tracking-tighter leading-[0.85] uppercase">
              Define Your <br/><span className="italic text-red-600">Resolution.</span>
            </h2>
          </div>
            ...
            {CATEGORIES.map((cat, idx) => (
              ...
              >
                <div className="relative">
                  <span className="text-9xl font-black text-red-500/10 group-hover:text-red-500/20 transition-all duration-700 outfit absolute -top-16 -left-6 -z-10 group-hover:scale-110">
                    0{idx + 1}
                  </span>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-center space-x-6">
                    <div className="h-px w-12 bg-stone-200 group-hover:w-24 group-hover:bg-red-500 transition-all duration-700"></div>
                    <span className="text-red-600 font-black text-[10px] uppercase tracking-[0.5em] opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-[-10px] group-hover:translate-x-0">
                      Step Inside
                    </span>
                  </div>
                </div>
      ...
      <div className="max-w-5xl mx-auto space-y-32 relative z-10">
        <div className="flex flex-col space-y-20">
          <button 
            ...
            className="w-fit flex items-center space-x-5 text-stone-400 hover:text-red-600 transition-all group"
          >
            <div className="w-12 h-12 rounded-full border border-stone-200 flex items-center justify-center group-hover:border-red-500 group-hover:bg-white transition-all">
          ...
          <div className="space-y-8">
            <div className="flex items-center space-x-8">
              <span className="text-8xl font-black text-red-500/20 outfit">0{catIndex}</span>
            ...
            <p className="text-stone-400 font-light text-3xl max-w-2xl border-l-4 border-red-500/20 pl-10 italic leading-relaxed">
          ...
          {activeCategory?.pledges.map((pledge, idx) => (
            ...
            >
              <div className="flex items-start space-x-16 flex-1">
                <span className="text-stone-200 text-2xl font-black outfit group-hover:text-red-500 transition-colors pt-2">
                  #{idx + 1}
                </span>
                <div className="space-y-6">
                  <h3 className="text-5xl sm:text-7xl font-black text-stone-900 outfit tracking-tighter group-hover:text-red-800 transition-all duration-500 leading-tight">
                    {pledge.text}
                  </h3>
              ...
              <div className="mt-12 sm:mt-0 opacity-0 group-hover:opacity-100 group-hover:-translate-x-10 transition-all duration-700">
                <div className="w-24 h-24 rounded-full bg-stone-900 text-white flex items-center justify-center shadow-3xl group-hover:bg-red-600 transition-colors">
